...
For testing out my os during development, I usually use [Bochs](http://bochs.sourceforge.net)
...
Let's go!
	...
	../bochs-2.5.1/configure --enable-smp --enable-cpu-level=6 --enable-acpi --enable-all-optimizations --enable-pci --enable-vmx --enable-logging --enable-vbe --enable-fpu --enable-sb16=dummy --enable-cdrom --disable-plugins --disable-docbook --with-term
	make all
	make install
{: .prettyprint}
...
Now we move this to *bochs-term* and compile the version with the debugger.
	...
	rm *
	../bochs-2.5.1/configure --enable-smp --enable-cpu-level=6 --enable-acpi --enable-all-optimizations --enable-pci --enable-vmx --enable-logging --enable-vbe --enable-fpu --enable-sb16=dummy --enable-cdrom --disable-plugins --disable-docbook --enable-debugger --enable-disasm --with-x11
	make all
	make install
{: .prettyprint}
